...
export const ConfirmEmailFullstack = Loadable({
  loader: () => import('./Pages/UsersFullstack/ConfirmEmail'),
  loading: Loading,
});
export const ConfirmPhoneFullstack = Loadable({
  loader: () => import('./Pages/UsersFullstack/ConfirmPhone'),
  loading: Loading,
});
...
export const Password = Loadable({
  loader: () => import('./Pages/Users/Password'),
  loading: Loading,
});
...
export const ParamsAccount = Loadable({
  loader: () => import('./Pages/params_v1/users'),
  loading: Loading,
});

export const Add_Admin = Loadable({
  loader: () => import('./Pages/params_v1/users/AddAdmin'),
  loading: Loading,
});


export const AppAllUsers = Loadable({
  loader: () => import('./Pages/informations_v1/users'),
  loading: Loading,
});

export const AppBlockedUsers = Loadable({
  loader: () => import('./Pages/informations_v1/users/BlockedUsersIndex'),
  loading: Loading,
});


export const AppVehiclesCategories = Loadable({
  loader: () => import('./Pages/informations_v1/vehicles'),
  loading: Loading,
});

export const AppVehiclesFamilies = Loadable({
  loader: () => import('./Pages/informations_v1/vehicles/AllFamVehIndex'),
  loading: Loading,
});

export const AppVehicle = Loadable({
  loader: () => import('./Pages/informations_v1/vehicles/VehicleIndex'),
  loading: Loading,
});
