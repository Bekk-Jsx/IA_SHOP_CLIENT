...
import {
  ...
  // v1 
  ParamsAccount, Add_Admin, AppAllUsers, AppVehiclesCategories, AppBlockedUsers, AppVehiclesFamilies, AppVehicle
} from '../pageListAsync';
...
import { getAllUsers } from '../../redux/actions/infoActions'
import { getAllVehCats } from '../../redux/actions/infoVehActions'


const Application = (props) => {
  const { history, getAllUsers, getAllVehCats, token } = props;
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        {/* Params  */}
        <Route path="/app/pages/add_admin" component={Add_Admin} />
        <Route path="/app/pages/account" component={ParamsAccount} />
        <Route path="/app/pages/users" component={AppAllUsers} />
        <Route path="/app/pages/blocked" component={AppBlockedUsers} />
        <Route path="/app/pages/vehicles" component={AppVehiclesCategories} />
        <Route path="/app/pages/families" component={AppVehiclesFamilies} />
        <Route path="/app/pages/vehicle" component={AppVehicle} />
...
Application.propTypes = {
  ...
  getAllVehCats: PropTypes.func.isRequired,
};
...
export default (injectIntl(ApplicationMapped));
